from builtin import username_checker, find_line
...
def hapusjin():
    ...
    if not username_checker(user_name, tempat_variable.data_user) and (user_name != "Bondowoso" and user_name != "Roro"):
        idxuser = find_line(tempat_variable.data_user,user_name)
        if(tempat_variable.data_user[idxuser][2]!="bandung_bondowoso" and tempat_variable.data_user[idxuser][2]!="roro_jonggrang"):
