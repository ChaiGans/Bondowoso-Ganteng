...
while(True):
    if(inp=="login"):
        ...
        if(tempat_variable.role!=-1 and tempat_variable.role_user=="bandung_bondowoso"):
            summonjin()
        ...
        if(tempat_variable.role!=-1 and tempat_variable.role_user=="jin_pembangun"):
            bangun()
        elif(not tempat_variable.role!=-1):
        ...
        if(tempat_variable.role!=-1 and tempat_variable.role_user=="jin_pengumpul"):
            kumpul()
        elif(not tempat_variable.role!=-1):
        ...
        if(tempat_variable.role!=-1 and tempat_variable.role_user=="roro_jonggrang"):
            hancurkancandi()
        elif(not tempat_variable.role!=-1):
